...
var file_penumbra_custody_threshold_v1alpha1_threshold_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_penumbra_custody_threshold_v1alpha1_threshold_proto_goTypes = []interface{}{
	...
	(*v1alpha1.TransactionPlan)(nil),                // 9: penumbra.core.transaction.v1alpha1.TransactionPlan
	(*v1alpha11.SignatureShare)(nil),                // 10: penumbra.crypto.decaf377_frost.v1alpha1.SignatureShare
...
var file_penumbra_custody_threshold_v1alpha1_threshold_proto_depIdxs = []int32{
	9,  // 0: penumbra.custody.threshold.v1alpha1.CoordinatorRound1.plan:type_name -> penumbra.core.transaction.v1alpha1.TransactionPlan
	...
	10, // 5: penumbra.custody.threshold.v1alpha1.FollowerRound2.shares:type_name -> penumbra.crypto.decaf377_frost.v1alpha1.SignatureShare
	11, // 6: penumbra.custody.threshold.v1alpha1.CoordinatorRound2.IdentifiedCommitments.commitments:type_name -> penumbra.crypto.decaf377_frost.v1alpha1.SigningCommitments
	6,  // 7: penumbra.custody.threshold.v1alpha1.CoordinatorRound2.PartialSigningPackage.all_commitments:type_name -> penumbra.custody.threshold.v1alpha1.CoordinatorRound2.IdentifiedCommitments
	11, // 8: penumbra.custody.threshold.v1alpha1.FollowerRound1.Inner.commitments:type_name -> penumbra.crypto.decaf377_frost.v1alpha1.SigningCommitments
